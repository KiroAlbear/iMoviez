...
//    public static final String INTENT_MOVIE_NAME_KEY = "MovieName";
//    public static final String INTENT_MOVIE_YEAR_KEY = "MovieName";
    public static final String INTENT_MOVIE_KEY = "MovieName";
